...
# August 8, 2023 data - No direct UST holdings (all in repo)
aug08_2023_ust_direct <- data.table(
  date = as.Date("2023-08-08"),
...
# August 8, 2023 - Repo collateral breakdown
aug08_2023_repo_collateral <- data.table(
  date = as.Date("2023-08-08"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = "912810RV2",
  maturity_date = as.Date("2047-02-15"),
  par_value = 26000000,
  unit_cost = 101.22,
  unit_price = 101.22,
  cost = 26316069,
...
# August 31, 2023 data - No direct UST holdings (all in repo)
aug31_2023_ust_direct <- data.table(
...
# August 31, 2023 - Repo collateral breakdown
aug31_2023_repo_collateral <- data.table(
  date = as.Date("2023-08-31"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = "912810TU2",
  maturity_date = as.Date("2043-08-15"),
  par_value = 43000000,
  unit_cost = 102.00,
  unit_price = 102.00,
  cost = 43860001,
...
# September 18, 2023 data - No direct UST holdings (all in repo)
sep18_2023_ust_direct <- data.table(
...
# September 18, 2023 - Repo collateral breakdown
sep18_2023_repo_collateral <- data.table(
  date = as.Date("2023-09-18"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = "912810SX7",
  maturity_date = as.Date("2051-05-15"),
  par_value = 43000000,
  unit_cost = 102.00,
  unit_price = 102.00,
  cost = 43860030,
...
# September 29, 2023 data - No direct UST holdings (all in repo)
sep29_2023_ust_direct <- data.table(
  date = as.Date("2023-09-29"),
  counterparty = character(0),
  asset_type = character(0),
  cusip = character(0),
  maturity_date = as.Date(character(0)),
...
# September 29, 2023 - Repo collateral breakdown
sep29_2023_repo_collateral <- data.table(
  date = as.Date("2023-09-29"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = "912829V49",
  maturity_date = as.Date("2027-01-15"),
  par_value = 94000000,
  unit_cost = 102.00,
  unit_price = 102.00,
  cost = 95880104,
...
# October 19, 2023 data - No direct UST holdings (all in repo)
oct19_2023_ust_direct <- data.table(
  date = as.Date("2023-10-19"),
  counterparty = character(0),
  asset_type = character(0),
  cusip = character(0),
  maturity_date = as.Date(character(0)),
...
# October 19, 2023 - Repo collateral breakdown
oct19_2023_repo_collateral <- data.table(
  date = as.Date("2023-10-19"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = "912810TS7",
  maturity_date = as.Date("2043-05-15"),
  par_value = 130500000,
  unit_cost = 102.28,
  unit_price = 102.28,
  cost = 133470089,
  fair_value = 133470089
)

# October 31, 2023 data - No direct UST holdings (all in repo)
oct31_2023_ust_direct <- data.table(
...
# October 31, 2023 - Repo collateral breakdown
oct31_2023_repo_collateral <- data.table(
  date = as.Date("2023-10-31"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = c("912828XL9", "912810TH1"),
  maturity_date = as.Date(c("2025-07-15", "2042-05-15")),
  par_value = c(10600000, 149000000),
  unit_cost = c(102.14, 101.94),
  unit_price = c(102.14, 101.94),
  cost = c(10827340, 151892289),
  fair_value = c(10827340, 151892289)
)
...
# November 20, 2023 data - No direct UST holdings (all in repo)
nov20_2023_ust_direct <- data.table(
  date = as.Date("2023-11-20"),
  counterparty = character(0),
  asset_type = character(0),
  cusip = character(0),
  maturity_date = as.Date(character(0)),
...
# November 20, 2023 - Repo collateral breakdown
nov20_2023_repo_collateral <- data.table(
  date = as.Date("2023-11-20"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = c("912810SH2", "912810SL3"),
  maturity_date = as.Date(c("2049-05-15", "2050-02-15")),
  par_value = c(60000000, 94000000),
  unit_cost = c(102.27, 102.28),
  unit_price = c(102.27, 102.28),
  cost = c(61362854, 96145551),
  fair_value = c(61362854, 96145551)
)

# November 30, 2023 data - No direct UST holdings (all in repo)
nov30_2023_ust_direct <- data.table(
...
# November 30, 2023 - Repo collateral breakdown
nov30_2023_repo_collateral <- data.table(
  date = as.Date("2023-11-30"),
  counterparty = "Bank 1",
  asset_type = "Repo Collateral",
  cusip = c("91282CJG7", "91282CEZ0"),
  maturity_date = as.Date(c("2030-10-31", "2032-07-15")),
  par_value = c(2790000, 154500000),
  unit_cost = c(102.00, 102.10),
  unit_price = c(102.00, 102.10),
  cost = c(2845857, 157745047),
  fair_value = c(2845857, 157745047)
)
...
aug08_2023_ust_combined <- rbind(aug08_2023_ust_direct, aug08_2023_repo_collateral)
aug31_2023_ust_combined <- rbind(aug31_2023_ust_direct, aug31_2023_repo_collateral)
sep18_2023_ust_combined <- rbind(sep18_2023_ust_direct, sep18_2023_repo_collateral)
sep29_2023_ust_combined <- rbind(sep29_2023_ust_direct, sep29_2023_repo_collateral)
oct19_2023_ust_combined <- rbind(oct19_2023_ust_direct, oct19_2023_repo_collateral)
oct31_2023_ust_combined <- rbind(oct31_2023_ust_direct, oct31_2023_repo_collateral)
nov20_2023_ust_combined <- rbind(nov20_2023_ust_direct, nov20_2023_repo_collateral)
nov30_2023_ust_combined <- rbind(nov30_2023_ust_direct, nov30_2023_repo_collateral)
...
aug08_2023_repo <- data.table(date = as.Date("2023-08-08"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(aug08_2023_repo_collateral$par_value), fair_value = sum(aug08_2023_repo_collateral$fair_value))
aug31_2023_repo <- data.table(date = as.Date("2023-08-31"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(aug31_2023_repo_collateral$par_value), fair_value = sum(aug31_2023_repo_collateral$fair_value))
sep18_2023_repo <- data.table(date = as.Date("2023-09-18"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(sep18_2023_repo_collateral$par_value), fair_value = sum(sep18_2023_repo_collateral$fair_value))
sep29_2023_repo <- data.table(date = as.Date("2023-09-29"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(sep29_2023_repo_collateral$par_value), fair_value = sum(sep29_2023_repo_collateral$fair_value))
oct19_2023_repo <- data.table(date = as.Date("2023-10-19"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(oct19_2023_repo_collateral$par_value), fair_value = sum(oct19_2023_repo_collateral$fair_value))
oct31_2023_repo <- data.table(date = as.Date("2023-10-31"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(oct31_2023_repo_collateral$par_value), fair_value = sum(oct31_2023_repo_collateral$fair_value))
nov20_2023_repo <- data.table(date = as.Date("2023-11-20"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(nov20_2023_repo_collateral$par_value), fair_value = sum(nov20_2023_repo_collateral$fair_value))
nov30_2023_repo <- data.table(date = as.Date("2023-11-30"), counterparty = "Bank 1", asset_type = "Repo", collateral = "US Treasury", coupon_rate = NA_real_, maturity_date = as.Date(NA), par_value = sum(nov30_2023_repo_collateral$par_value), fair_value = sum(nov30_2023_repo_collateral$fair_value))
...
pyusd_ust_detailed <- rbind(
  aug08_2023_ust_combined, aug31_2023_ust_combined,
  sep18_2023_ust_combined, sep29_2023_ust_combined,
  oct19_2023_ust_combined, oct31_2023_ust_combined,
  nov20_2023_ust_combined, nov30_2023_ust_combined,
...
pyusd_repo <- rbind(
  aug08_2023_repo, aug31_2023_repo,
  sep18_2023_repo, sep29_2023_repo,
  oct19_2023_repo, oct31_2023_repo,
  nov20_2023_repo, nov30_2023_repo,
...
pyusd_circulation <- data.table(
  date = as.Date(c("2023-08-08", "2023-08-31",
  ...
  circulation = c(26905006, 44376440,
                  44376440, 94396540,
                  130528541, 158956937,
                  157956966, 156753068,
                  266046276, 264531846,
...
pyusd_ust <- data.table(
  date = as.Date(c("2023-08-08", "2023-08-31",
                   ...
                   "2025-10-10", "2025-10-15", "2025-10-31", "2025-11-10", 
                   "2025-11-28", "2025-12-17", "2025-12-31")),
  ust_holdings = c(26316069, 43860001,
                   43860030, 95880104,
                   133470089, 162719629,
                   157508405, 160590905,
                   271162025, 270270484,
